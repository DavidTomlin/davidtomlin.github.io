$(document).ready(function(){
  ...
  $(window).scroll(function() {
    ...
    var topResumePg = $("#resume-page").offset().top;
    var topContactPg = $("#contact-page").offset().top;
    var y = 50;

    if (topContactPg - distance < y) {
      $("#current-page").html("Contact");
    } else if (topResumePg - distance < y) {
      $("#current-page").html("Resume");
  ...
  window.imgSwap = function(element) {
    ...
    if (source.indexOf("_green.png") != -1) {
      source = source.replace(/_green.png/g, "_white.png");
    } else if (source.indexOf("_white.png") != -1) {
      source = source.replace(/_white.png/g, "_green.png");
    }
